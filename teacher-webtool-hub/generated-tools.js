window.generatedTeacherTools = {
  "generatedAt": "2026-06-26T06:43:08.474Z",
  "teachers": {
    "정승원": [
      {
        "title": "몬티홀 딜레마 실험",
      ...
      {
        "title": "조건부 확률 실험기",
        "description": "베이즈 정리 확률과 통계 조건부 확률 실험기 검사 정확도가 99%라면 양성자의 99%가 환자일까요? 기저율과 위양성을 움직이며 직관을 다시 계산합니다.",
        "tags": [
          "확률",
          "통계"
        ],
      ...
      {
        "title": "SET 게임",
        "description": "속성 분류 수학 게임 SET 게임 각 속성이 모두 같거나 모두 다른 세 장을 찾습니다. 3속성 버전은 모양·색깔·투명도를 비교합니다.",
        "tags": [
          "인공지능 수학",
          "게임형 수업"
        ],
      ...
      {
        "title": "파라오 코드",
        "description": "84 54 80 6 12 수 연산 수학 게임 파라오 코드 6면·8면·12면 주사위의 수를 계산해 목표 숫자를 만들고, 난이도별 배점을 조별로 획득합니다.",
        "tags": [
          "게임형 수업"
        ],
    ...
    "정종엽": [
      {
        ...
        "description": "μ 95% 신뢰구간 통계적 추정 모평균의 추정: 일부로 전체를 예측한다 데이터를 직접 입력하고 표본평균·표준편차를 구한 뒤, 95%·99% 신뢰구간을 계산해 봅니다.",
        "tags": [
          "통계적 추정",
          "통계"
        ],
      ...
      {
        "title": "윷놀이로 배우는 통계적 확률",
        "description": "동전과 윷을 직접 던지며 앞면·뒷면 누적 통계를 관찰하고, 전략적으로 전진하며 수학적 확률과 통계적 확률의 차이를 체험합니다.",
        "tags": [
          "확률",
          "통계"
        ],

...
const TOOL_GUIDES = {
  "황금비 측정 실험실": {
    ...
    tips: "+/− 버튼, 슬라이더, 마우스 휠로 확대·축소할 수 있습니다. ‘이동’ 도구나 스페이스바를 누른 채 드래그하면 사진 위치가 바뀝니다. 측정 뒤 A·B 점을 끌어 경계를 세밀하게 조정하고, ‘황금 사각형 비교’를 켜면 같은 짧은 변을 기준으로 한 이상적인 황금 사각형이 점선으로 표시됩니다.",

...
이 보관본의 1~19, 24~25, 33~38, 41, 68~73번, 총 34개가 승인되었습니다. 16·17·36번은 원본 배치를 유지하는 색상 변경이며 나머지 31개는 새 장면입니다. 당시 선택하지 않은 47개와 이후 추가된 웹툴의 썸네일은 그대로 유지합니다. 번호는 이 보관본에 고정하며, 적용 대상은 `assets/tool-thumbnails.js`의 `approvedIds` 목록으로 제한합니다.
